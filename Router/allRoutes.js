...
export const allRoutes = [
    ...
    new Route("/account", "Mon compte", "/Pages/account.html", ["admin", "ROLE_USER"]),
    new Route("/editPassword", "Modifier le mot de passe", "/Pages/auth/editPassword.html", ["admin", "ROLE_USER"]),
    new Route("/allReservations", "Toutes les réservations", "/Pages/reservations/allReserv.html", ["ROLE_USER"]),
